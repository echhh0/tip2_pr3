...
import (
	...
	"tip2_pr3/proto"
	grpcapi "tip2_pr3/services/auth/internal/grpc"
	httpapi "tip2_pr3/services/auth/internal/http"
	"tip2_pr3/services/auth/internal/service"
...
func main() {
	...
	httpApp := middleware.RequestID(middleware.AccessLog(logger)(httpMux))
